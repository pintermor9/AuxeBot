...
class Levelling(commands.Cog):
    def __init__(self, client):
        ...
        self.client.levels = requests.get(f"https://lvlsys-api.pintermor9.repl.co/?key={self.client.apikey}").json()
    ...
    async def on_message(self, message):
        ...
        xp = requests.get(f"https://lvlsys-api.pintermor9.repl.co/add/{authorID}/{random.randint(10, 30)}?key={self.client.apikey}").json()[authorID]
